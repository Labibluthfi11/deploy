                ...
                <div class="bg-white dark:bg-gray-800 px-6 pt-6 pb-4">
                    ...
                    <div class="mt-6">
                        ...
                        <textarea
                            ...
                            class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm transition-colors"></textarea>
...
{{-- ✅ FIXED SCRIPT - 2 PARAMETERS --}}
<script>
    // ✅ FUNCTION DENGAN 2 PARAMETER (id, routeUrl)
    function openRejectModal(id, routeUrl) {
        console.log('🔥 openRejectModal called:', { id, routeUrl }); // Debug log
        ...
        // ✅ SET ACTION DARI PARAMETER (bukan hard-coded)
