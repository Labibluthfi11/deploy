...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // ========== ABSENSI - GET ENDPOINTS (tanpa rate limit karena read-only) ==========
    ...
    // ✅ FIXED: Notification store - KHUSUS ADMIN!
    // Endpoint ini dipanggil dari Admin Panel (Web Laravel)
    // Ada role check di controller (isAdmin())
    Route::post('/notifications', [NotificationController::class, 'store'])
        ->middleware('throttle:20,1');  // ✅ Max 20x/menit (admin mungkin kirim ke banyak user)
});
