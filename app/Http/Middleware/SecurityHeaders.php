...
class SecurityHeaders
{
    ...
    {
        // 1. Inisialisasi Nonce via Vite (Wajib buat Laravel 12 + Tailwind)
        $nonce = \Illuminate\Support\Facades\Vite::useCspNonce();
        
        // Simpan ke config buat dipanggil di Blade
        ...
        $csp = [
            "default-src 'self'",
            "script-src 'self' 'unsafe-eval' 'nonce-$nonce' cdnjs.cloudflare.com cdn.jsdelivr.net",
            "style-src 'self' 'unsafe-inline' 'nonce-$nonce' fonts.googleapis.com cdnjs.cloudflare.com cdn.jsdelivr.net",
